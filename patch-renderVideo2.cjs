...
const newRenderVideoCode = `import { Clip, EditorSettings } from '../types';
...
export const renderVideoClip = async (
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      renderFormData.append('videoId', videoId); // use the videoId that was uploaded on the first page
...
fs.writeFileSync('src/lib/renderVideo.ts', newRenderVideoCode);
