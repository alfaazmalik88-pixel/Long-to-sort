...
const replacement1 = `
  ...
  const processFile = async (file: File) => {
    ...
    if (!isUnder1080p) {
      setResolutionWarning("⚠️ Warning: Your video is above 1080p (4K/2K). Please upload a video with 1080p or lower resolution. High-resolution videos may fail to process.");
      return;
    }
